...
export function draftCampaignFromPromotion(args: {
  ...
  const blocks: Block[] = [
    { id: cuid(), type: "big-number", props: {
        ...
        tagline: copy.body,
        bgImageUrl: "https://d3k81ch9hvuctc.cloudfront.net/company/REVNSD/images/65d78707-8304-4824-91b2-b23657f4b8dd.jpeg", // replaced by Gemini banner at render time
        bgColor: "#FFBDCF",
        textColor: "#FFFFFF",
        ctaLabel: copy.cta,
    ...
    { id: cuid(), type: "app-promo", props: {
        imageUrl: "https://d3k81ch9hvuctc.cloudfront.net/company/REVNSD/images/3cb2b8b3-eafd-4121-ba02-afbaa01cf10e.jpeg",
