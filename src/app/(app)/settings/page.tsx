              ...
              <ul className="divide-y divide-border">
                {[
                  ...
                  <li key={m.email} className="flex items-center justify-between p-3">
                    <div className="flex items-center gap-3">
                      <div className="h-8 w-8 rounded-full bg-muted grid place-items-center text-[12px]">{m.name[0]}</div>
                      <div>
          ...
          <Card>
            ...
            <CardContent className="pt-0 space-y-2.5">
              <div className="rounded-md border border-border bg-card/40 p-3 flex items-center justify-between">
                <div>
                  <div className="text-[14px] font-medium">Asset ingestion (external agent)</div>
                  <div className="text-[11px] text-muted-foreground font-mono">sk_live_assets_••••_K2pq</div>
                </div>
